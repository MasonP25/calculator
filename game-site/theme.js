...
(function() {
  var CLOAKS = {
    ...
    clever: { name: 'Clever', icon: '\u{1F537}', title: 'Clever | Portal', favicon: 'https://www.clever.com/favicon.ico' },
    ...
    mathia: { name: 'Mathia', icon: '\u{1F4B9}', title: 'Mathia', favicon: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect fill='%23005DAA' width='100' height='100' rx='15'/><text x='50' y='68' font-size='50' fill='white' text-anchor='middle' font-family='Arial' font-weight='bold'>M</text></svg>" },
...
(function() {
  ...
  var LAYERS = [
    ...
    { count: mobile ? 4  : 8,  speed: 1.0, rMin: 3.5, rMax: 5.5, aMin: 0.35, aMax: 0.6, parallax: 0.18 },
    { count: mobile ? 3  : 6,  speed: 1.3, rMin: 5.0, rMax: 7.0, aMin: 0.4,  aMax: 0.65, parallax: 0.28 }
  ];
