...
(function() {
  ...
  function buildCSS(t) {
    return `
      ...
      /* Cards & panels */
      .card { background:${t.bg2}!important; border:none!important; color:${t.text}!important; }
      ...
      .game-card:hover { border-color:${t.accent}!important; box-shadow:0 8px 30px ${t.glow}!important; }
