...
(function() {
  ...
  function buildCSS(t) {
    return `
      ...
      .random-btn { color:${t.bg2}!important; }
  ...
  function createPicker() {
    ...
    Object.assign(panel.style, {
      position:'fixed', top:'50px', left:'68px', zIndex:'1000',
...
(function() {
  ...
  var LAYERS = [
    { count: mobile ? 45 : 130, speed: 0.2, rMin: 0.8, rMax: 1.8, aMin: 0.08, aMax: 0.2, parallax: 0.02 },
    { count: mobile ? 30 : 80, speed: 0.45, rMin: 1.5, rMax: 2.8, aMin: 0.15, aMax: 0.35, parallax: 0.05 },
    { count: mobile ? 16 : 45, speed: 0.7, rMin: 2.5, rMax: 4.0, aMin: 0.25, aMax: 0.5, parallax: 0.1 },
    { count: mobile ? 8  : 20, speed: 1.0, rMin: 3.5, rMax: 5.5, aMin: 0.35, aMax: 0.6, parallax: 0.18 },
    { count: mobile ? 5  : 14, speed: 1.3, rMin: 5.0, rMax: 7.0, aMin: 0.4,  aMax: 0.65, parallax: 0.28 }
  ];
...
(function() {
  ...
  function _show() {
    ...
    _z.style.cssText = 'position:fixed;inset:0;z-index:2147483647;background:#fff;display:flex;flex-direction:column;align-items:center;justify-content:center;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;color:#202124;padding:20px;cursor:default;';
    _z.innerHTML = '<div style="max-width:520px;text-align:center;">'
      + '<svg xmlns="http://www.w3.org/2000/svg" width="72" height="72" viewBox="0 0 24 24" fill="#d93025"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 11h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11V12z"/></svg>'
      + '<h1 style="font-size:1.6rem;margin:20px 0 8px;color:#202124;font-weight:500;">This site has been restricted</h1>'
      + '<p style="color:#5f6368;margin:0 0 24px;font-size:0.9rem;font-weight:400;">by your network administrator</p>'
      + '<div style="background:#f1f3f4;padding:14px 18px;border-radius:8px;text-align:left;font-size:0.85rem;color:#3c4043;line-height:1.7;word-break:break-all;">'
      + '<div><strong style="color:#202124;">URL:</strong> ' + _esc(location.href) + '</div>'
      + '<div><strong style="color:#202124;">Category:</strong> Games &amp; Entertainment</div>'
      + '</div>'
      + '<p style="margin-top:24px;font-size:0.78rem;color:#80868b;line-height:1.5;">If you believe this site has been restricted in error, please contact your administrator.</p>'
      + '</div>';
